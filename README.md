...
အမှန်တော့ ဒေတာက်အဖြေပေါ်တွင် လုံးဝ သက်ရောက်ခြင်း မရှိတော့သည်တော့ မဟုတ်။ နောက်တစ်ကြိမ် သေချာပြန်ကြည့်လျှင် တွေ့ရနိုင်သည်။ ပထမ Column နှင့် ဒုတိယ Column တန်ဖိုးတူလျှင် အဖြေ `0` ဖြစ်၍ မတူလျှင် အဖြေ `1` ဖြစ်နေခြင်းဖြစ်သည်။ ဤသည်ကို ကျွန်ုပ်တို့ ဦးနှောက်က တွေးဆနိုင်သကဲ့သို့ ပရိုဂရမ်ကလည်း အဖြေမှန်ထုတ်ပေးနိုင်အောင် ပြင်ဆင်မည် ဖြစ်သည်။

အထက်က ပရိုဂရမ်တွင် Neuron တစ်ခုနှင့် Layer တစ်ခုသာ ပါဝင်သည်။ လက်တွေ့တွင် Artificial neural network တစ်ခု၏ ဖွဲ့စည်းပုံမှာ အောက်ပါအတိုင်း ဖြစ်နိုင်သည်။
...
နမူနာဒေတာသည် Row (၄) ခုရှိ၍ Column (၃) ခုစီပါဝင်သည့် Array Matrix တစ်ခုဖြစ်သည်။ ထို Matrix ကို စီစစ်နိုင်ရန် `weights_zero` အား Row (၃) ခုနှင့် Column (၄) ခုပါဝင်သော Random Array Matrix အဖြစ် သတ်မှတ်ထားသည်။ `weights_zero` နှင့် `inputs` ဒေတာကို Matrix Multiplication နည်းစနစ်နှင့် မြှောက်လိုက်သည့်အခါ Row (၄) လေးခုရှိ၍ Column (၁) ခုရှိသော ရလဒ်ကို ရရှိမည်ဖြစ်သည်။ ထိုရလဒ်နှင့် ဆက်လက်တွဲဖက် အလုပ်လုပ်နိုင်စေရန် Row (၄) ခုနှင့် Column (၁) ခုရှိသော `weights_one` ကို နောက်ထပ် Random Array Matrix တစ်ခုအဖြစ် ကြေငြာ သတ်မှတ်ထားခြင်းဖြစ်သည်။

**မှတ်ချက်** - နမူနာတွင် တွေ့ရသော `nj` ဆိုသည်မှာ Numpy ကို နမူနာယူ ဖန်တီးထားသော NumJs ခေါ် JavaScript Library ဖြစ်သည်။ ပထမနမူနာတွင် သင်္ချာဆိုင်ရာ တွက်ချက်မှုများအတွက် လိုအပ်သည့် Function များကို တစ်ပါတည်း ထည့်သွင်းရေးသားသော်လည်း၊ ဤနမူနာတွင် ကိုယ်တိုင်မရေးတော့။ NumJs ကို အသုံးပြုထားသည်။
...
ထို့နောက် ပထမနမူနာတွင် ကဲ့သို့ပင် ရရှိလာသော ရလဒ်ကို အသုံးပြု၍ Weights များကို ပြုပြင်လိုက်သည်။ ထို့ကြောင့် အကြိမ်ကြိမ် လေ့ကျင့်လိုက်မည် ဆိုလျှင် နောက်ဆုံးတွင် အဖြေမှန်အနီးစပ်ဆုံး ထုပ်ပေးနိုင်သော Weights များကို ရရှိမည်ဖြစ်သည်။ ရရှိလာသည့် Weight များကို သုံး၍ အောက်ပါအတိုင်း စမ်းသပ် ကြည့်နိုင်သည်။
...
Iteration အကြိမ်ရေ 60,000 လေ့ကျင့်ပြီးနောက် `1, 0, 0` အတွက် အဖြေမှန် `1 (0.95)` ဖြစ်၍ `1, 1, 0` အတွက် အဖြေမှန် `0 (0.002)` ဖြစ်ကြောင်း မှန်ကန်စွာ စီစစ်နိုင်သည့် ပရိုဂရမ်တစ်ခုကို ရရှိသွားပြီ ဖြစ်ပေတော့သည်။
