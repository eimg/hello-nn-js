...
လက်ရှိပရိုဂရမ်အား စွမ်းဆောင်ရည်ပိုမို ကောင်းမွန်စေရန် Optimize လုပ်၍ရနိုင်သည့် နည်းစနစ်အမျိုးမျိုး ရှိနေသည်။ ၄င်းတို့ထဲမှ Gradient Descent နည်းစန်အား အသုံပြု၍ ပိုအမှားနည်းသော စနစ်တစ်ခု ဖြစ်စေရန် ပြင်ဆင်ဖြည့်စွက်မည်။

![Gradient Descent](http://iamtrask.github.io/img/sgd_optimal.png)

အထက်တွင် ဆိုခဲ့ပြီးသကဲ့သို့ပင်၊ ဤနေရာတွင် Gradient Descent သဘောသဘာဝကို အကျယ်ဖော်ပြနိုင်မည် မဟုတ်ပဲ၊ ရေးသားထားသော ကုဒ်၏ ထူးခြားချက်ကိုသာ ဖော်ပြနိုင်မည်ဖြစ်ပေသည်။ Part - 2 တွင် ရေးသားခဲ့သည့် ကုဒ်ကိုပင် ဆက်လက်အသုံးပြုမြင်ဖြစ်ပြီး ပထမဆုံးပြင်ဆင်ချက်မှာ `alpha` ခေါ် တန်ဖိုးတစ်ခု သတ်မှတ်လိုက်ခြင်းပင် ဖြစ်သည်။ Weights တန်ဖိုးများ ချိန်ညှိရာတွင် `alpha` တန်ဖိုးကို ထည့်ကစားသွားရန် ရည်ရွယ်သည်။

```javascript
var alpha = 10;
```

လက်တွေ့တွင် `alpha` တန်ဖိုးကို ပုံသေပြော၍ ရနိုင်မည်မဟုတ်ပဲ၊ အသင့်တော်ဆုံးတန်ဖိုး ရရှိရန် အမျိုးမျိုးပြောင်း၍ စမ်းသပ်ကြည့်ရန် လိုအပ်ပေမည်။ ဤနေရာတွင်တော့ စပ်သပ်ပြီးတန်ဖိုးများမှ အသင့်တော်ဆုံးဖြစ်သည့် `10` ကို တစ်ခါတည်း ကြိုတင်သတ်မှတ်ထားလိုက်သည်။ ဆက်လက်ပြီး `layer_two` ကို အသုံးပြု၍ `error` စီစစ်ရာတွင် ယခုကဲ့သို့ ပြင်ဆိုင်ရန် လိုအပ်သည်။

```javascript
var layer_two_error = layer_two.subtract(test_result);
```

မူလက `test_result` မှ `layer_two` ကို နှုတ်ယူခြင်းဖြစ်ပြီး၊ ယခုအခါ `layer_two` မှ `test_result` ကို နှုတ်ယူခြင်းဖြစ်သည်။ ဆက်လက်ပြီး Weights များ ချိန်ညှိမှုကို ယခုကဲ့သို့ ပြင်ဆင်ရန် လိုအပ်သည်။
...
မူလက Weights များချိန်ညှိရာတွင် လက်ရှိ Weights တွင် အသစ်ရရှိလာသည့် တန်ဖိုးများကို ပေါင်းထည့်ခြင်းဖြစ်သော်လည်း ယခုအခါ လက်ရှိ Weights မှ အသစ်ရရှိလာသော တန်ဖိုးကို `alpha` နှင့် မြှောက်၍ နှုတ်ယူသွားခြင်း ဖြစ်သည်။ ဤအပြောင်းအလဲ အဘယ့်ကြောင့် အရေးပါရသနည်း ဟူသည်ကို [မူရင်းဆောင်းပါးတွင်](http://iamtrask.github.io/2015/07/27/python-network-part2/) လေ့လာနိုင်ပါသည်။
...
```
Error:0.5000135194530013
Error:0.010626371915259706
Error:0.00726000807089573
Error:0.005833823291177704
Error:0.005001455307140716
Error:0.004440934900653816
```
...
```
Error:0.49890257729692866
Error:0.0028158347351834893
Error:0.0017176682103336883
Error:0.0013349032801991025
Error:0.0011258896811994434
Error:0.000989941835100877
```
