...
လက်ရှိပရိုဂရမ်အား စွမ်းဆောင်ရည်ပိုမို ကောင်းမွန်စေရန် Optimize လုပ်၍ရနိုင်သည့် နည်းစနစ်အမျိုးမျိုး ရှိသေးသည်။ ၄င်းတို့ထဲမှ Gradient Descent နည်းစနစ်အား အသုံပြု၍ ပိုအမှားနည်းသော စနစ်တစ်ခု ဖြစ်လာစေရန် ပြင်ဆင်ဖြည့်စွက်မည်။

![Gradient Descent](http://iamtrask.github.io/img/sgd_optimal.png)

ဤနေရာတွင် Gradient Descent သဘောသဘာဝကို အကျယ်ဖော်ပြနိုင်မည် မဟုတ်ပဲ၊ ရေးသားထားသော ကုဒ်၏ ထူးခြားချက်ကိုသာ ဖော်ပြနိုင်မည်ဖြစ်ပေသည်။ Part - 2 တွင် ရေးသားခဲ့သည့် ကုဒ်ကိုပင် ဆက်လက် အသုံးပြုမြင်ဖြစ်ပြီး ပထမဆုံးပြင်ဆင်ချက်မှာ `alpha` ခေါ် တန်ဖိုးတစ်ခု သတ်မှတ်လိုက်ခြင်းပင် ဖြစ်သည်။ Weights တန်ဖိုးများ ချိန်ညှိရာတွင် မူလကကဲ့သို့ Matrix Multiplication သက်သက် မဟုတ်တော့ပဲ `alpha` တန်ဖိုးကို ထည့်ကစားသွားရန် ရည်ရွယ်သည်။

```javascript
var alpha = 10;
```

လက်တွေ့တွင် `alpha` တန်ဖိုးကို ပုံသေကားကျ သတ်မှတ်၍ ရနိုင်မည်မဟုတ်ပဲ၊ အသင့်တော်ဆုံးတန်ဖိုး ရရှိရန် အမျိုးမျိုးပြောင်း၍ စမ်းသပ်ကြည့်ရန် လိုအပ်ပေမည်။ ဤနေရာတွင်တော့ စပ်သပ်ပြီးတန်ဖိုးများမှ အသင့်တော်ဆုံးဖြစ်သည့် `10` ကို တစ်ခါတည်း ကြိုတင်သတ်မှတ်ထားလိုက်သည်။ ဆက်လက်၍ `layer_two` ကို အသုံးပြု၍ `error` စီစစ်သည့်ကုဒ်ကို ယခုကဲ့သို့ ပြင်ဆင်ရန် လိုအပ်သည်။

```javascript
var layer_two_error = layer_two.subtract(test_result);
```

မူလက `test_result` မှ `layer_two` ကို နှုတ်ယူခြင်းဖြစ်ပြီး၊ ယခုအခါ `layer_two` မှ `test_result` ကို နှုတ်ယူခြင်းဖြစ်သည်။ ဆက်လက်၍ Weights များ ချိန်ညှိမှုကို ယခုကဲ့သို့ ပြင်ဆင်ရန် လိုအပ်သည်။
...
မူလက Weights များချိန်ညှိရာတွင် လက်ရှိ Weights Matrix တွင် အသစ်ရရှိလာသည့် တန်ဖိုးများကို ပေါင်းထည့်ခြင်း ဖြစ်သော်လည်း ယခုအခါ လက်ရှိ Weights Matrix မှ အသစ်ရရှိလာသော တန်ဖိုးကို `alpha` နှင့် မြှောက်၍ရသည့် တန်ဖိုးကို နှုတ်ယူသွားခြင်း ဖြစ်သည်။ ဤအပြောင်းအလဲ အဘယ့်ကြောင့် အရေးပါသနည်း ဟူသည်ကို သဘောပေါက်ရန် Gradient Descent ကို ကောင်းမွန်စွာ နားလည်အောင် လေ့လာရန်သည်။
